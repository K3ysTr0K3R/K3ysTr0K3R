...
Multi-vector HTTP, RCE, and SQLi scanners, plus mass service enumeration for Apache, WebDAV, RTSP, and related targets.
 
 
 
Exploits
 
Proof-of-concept RCE, LPE, and LFI exploits for CVE-listed vulnerabilities.
 
 
 
Engineering
 
Recon automation, validation utilities, and custom penetration testing helpers.
...
I'm always open to ethical security research, exploit development, and tool building with like-minded individuals. If you share the same passion, let's connect.
...
## GitHub Statistics
   ...
   [github stats](https://github.com/K3ysTr0K3R)   [streak stats](https://github.com/K3ysTr0K3R) 
